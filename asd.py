...
class Game:
    def __init__(self, partner, ya, starting_question, low_amount, high_amount):
        ...
        self.check_ans_btn = Button(self.dismiss_export_frame, text="Check Ans", font="arial 10 bold", fg="black",
                                    bg="#8589FF", pady=7, width=13,
                                    command=lambda: self.check_ans(low_amount, high_amount, ya, starting_question,
                                                                   questions_played, how_many_right,
                                                                   self.history_questions))
        self.check_ans_btn.grid(row=1, column=1)


        def check_ans(self, low_amount, high_amount, ya, starting_question, questions_played, how_many_right,
                  history_questions):
    ...
    def next(self, low_amount, high_amount, ya, starting_question, questions_played, how_many_right, history_questions):
        ...
        self.check_ans_btn = Button(self.dismiss_export_frame, text="Check Answer", font="arial 10 bold", fg="black",
                                    bg="#8589FF", pady=7, width=13,
                                    command=lambda: self.check_ans(low_amount, high_amount, ya,
